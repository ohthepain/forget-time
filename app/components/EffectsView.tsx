...
function makeProgram1(gl: WebGLRenderingContext): WebGLProgram | null {
...
const makeProgram2 = (gl: WebGLRenderingContext): WebGLProgram | null => {
...
export const EffectsView = ({
  ...
  useEffect(() => {
    ...
    const program1 = makeProgram1(gl)!;
    const program2 = makeProgram2(gl)!;
    const programFinal = makeProgramFinal(gl)!;
    ...
    const timeLocation1: WebGLUniformLocation | null = gl.getUniformLocation(
      program1,
      'u_time',
    );
    ...
    const timeLocation2: WebGLUniformLocation | null = gl.getUniformLocation(
      program2,
      'u_time',
    );

    const texture1Location: WebGLUniformLocation | null = gl.getUniformLocation(
      programFinal,
      'u_texture1',
    );
    const texture2Location: WebGLUniformLocation | null = gl.getUniformLocation(
      programFinal,
      'u_texture2',
    );
    if (
